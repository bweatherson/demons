...
```{tikz, abc-game-weak-dominance, fig.cap = "A version of the ABC game that supports weak dominance.", fig.ext = 'png', cache=TRUE, engine.opts=list(extra.preamble=c("\\usepackage{chessboard}"))}
\setchessboard{smallboard, showmover = false}
\newchessgame
\chessboard
```

<!--chapter:end:latest-export.md-->
