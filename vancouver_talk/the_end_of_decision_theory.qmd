...
:   It isn't very practical in this case. Chooser can't bet on the winner.^[Actually, it's a bit more complicated than that, but let's stick with this characterisation for now.]
...
- That's exactly the same technical task as solving Salesman by brute force.^[Actually one step harder because of the multiplication, but otherwise the same.]