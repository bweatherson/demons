...
3. Buyers of uesd cars do not; they only know how good the model is in general.
...
- Why did Democrats do so well last month? Because of a backlash to Republican attacks on abortion rights.
...
At this point you might expect that I'd have a theory that does go silent on a bunch of hard cases, and you'd be right.

- And I'm happy to talk about that theory at literally any length people want.
